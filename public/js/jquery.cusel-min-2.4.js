...
else var cuselHoverVal=$(this).find(".cuselActive").attr("val");$(this).find(".cusel-scroll-wrap").eq(0).css("display","none").end().find(".cuselOptHover").eq(0).removeClass("cuselOptHover");$(this).find("input").eq(0).change();}
